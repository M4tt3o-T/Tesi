...
# --- PERCORSI ---
BASE_DIR = os.path.join(os.path.abspath(os.path.dirname(__file__)), '..') + os.sep
TRAIN_DIR = os.path.join(BASE_DIR, 'TRAINING', 'NORMALIZED') + os.sep
CACHE_FILE = os.path.join(BASE_DIR, "EXTRACTED_DATA.npy")

# --- PARAMETRI DATI ---
SENSORS = np.arange(16)
NMIN = 4
SOGLIA = 0.25

# --- LISTE COMPONENTI ---
COMPONENTS = [
    'ACETIC_ACID', 'AIR', 'ACETONE', 'AMMONIUM_CHLORIDE', 'AMMONIA', 'CALCIUM_NITRATE', 'BUTANE',
...
LISTA_AMMESSI_STAT = ['CALCIUM_NITRATE', 'ISOPROPANOL']

# Gruppi usati per la classificazione gerarchica
...
MODEL_STAGE1_BIN = LGBMClassifier(
    n_estimators=1000, 
    learning_rate=0.01, 
    num_leaves=63,
    scale_pos_weight=15.0, 
...
MODEL_STAGE2_BIN = MLPClassifier(
...
HYDROCARBON_TRESHOLD = [0.4, 0.5, 0.6, 0.7, 0.8]

# --- ARCHITETTURE MLP PER I TEST ---
MLP_ARCHITECTURES = [
...
TOP_HYDROCARBON_MLP_ARCHITECTURES = [
    (64, 32),
    (64, 32, 16, 8),
    (64, 256, 64),
    (512,)
